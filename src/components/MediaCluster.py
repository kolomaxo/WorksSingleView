...
class MediaCluster:
    ...
    def set_titles(self):
        ...
        for title in self.title_candidates:
            ...
            distance = self.__normalized_levenshtein(title.lower(), canonized_title)
